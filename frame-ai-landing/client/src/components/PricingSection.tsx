...
export default function PricingSection() {
  ...
  const { selectPlan, openModal, isAuthenticated } = useApp();
  ...
  return (
    <section id="pricing" className="py-24 px-8 md:px-12 bg-gradient-to-b from-black to-gray-900">
            ...
            >
              ...
              <div className="p-8 md:p-10">
                ...
                <button
                  ...
                  className={`w-full py-3 px-6 mb-8 font-mono text-sm uppercase tracking-widest font-semibold transition-all duration-300 cursor-pointer ${
                    plan.highlight
                      ? "bg-orange-500 text-black hover:bg-orange-600"
                      : "bg-gray-800 text-white hover:bg-gray-700 border border-gray-700"
                  }`}
                >
                  {isAuthenticated ? "Abrir o Studio" : plan.cta.label}
                </button>
